...
//: This makes use of the __Fourier theorem__, i.e., *Any complex periodic waveform can be decomposed into the __sum__ of an arbitrary numbere of sinewaves.*
...
let squareWave = cmplxWave(sampleRate: 44100, frequency: 200, amplitude: 1.0, nSamples: 1000, numHarmonics: 17)
squareWave.map() {$0}
